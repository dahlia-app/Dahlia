package rest.dahlia.domain.manager.base
...
/**
 * Allows for easy management of app preferences
 *
 * @param prefs Underlying [SharedPreferences] instance containing the persisted settings
 */
abstract class BasePreferenceManager(
    ...
    /**
     * Represents a stateful preference value, changes to this value will be immediately reflected in the UI
     *
     * Don't use this class directly, instead use one of the preset delegate functions
     *
